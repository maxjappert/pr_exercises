...
def testMNIST13() -> None:
    ...
    # Kernelpar: float
    svm_image(train, test, is_cifar=False, linear=False, C=100, kernel='poly', kernelpar=0.3)

    # This works very well:
    #svm_image(train, test, is_cifar=False, linear=False, C=10, kernel='poly', kernelpar=0.5)
